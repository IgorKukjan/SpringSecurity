...
<body>
		<form method='POST'
			...
			<fieldset class="boxBody">
				...
				<input type="text" name="user_login" tabindex="1" placeholder="user_login" required/>

				<label>
					 <a href="#" class="rLink" tabindex="5">Forget your password?</a>
					Password
				</label>
				<input type="password" name="password_login" tabindex="2" required placeholder="password_login"/>
